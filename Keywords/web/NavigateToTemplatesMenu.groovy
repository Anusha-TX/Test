...
public class NavigateToTemplateMenu {

	KeywordLogger log=new KeywordLogger()
	@Keyword

	def navigateTotemplateMenu () {
		try {
			...
			TestObject navigatetoTemplates=findTestObject('Object Repository/Web/Dispute/Maintain/Templates/Accounting Entries/Page_TRIPS/div_Templates')
			WebUI.click(navigateToDisputeField)
			WebUI.click(navigateToMaintain)
			WebUI.click(navigatetoTemplates)
