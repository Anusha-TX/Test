...
public class LegalFundsAcquistn {
	...
	def legalCaseProcesser(String bankid,String acctno,String actbal) {
		try {
			...
			TestObject firstcaseID =findTestObject('Object Repository/Web/Dispute/Process/Case Processor/Page_Case Processor/selectfirstgeneratelettercase')
			TestObject selectAcct_identification =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Case Processor/span_Account Identification Action')
			TestObject enter_bankId =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/input_Bank_bankID')
			TestObject enter_acctNum =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/input_Account_account')
			TestObject search_btn =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/svg_Jurisdiction_bi bi-plus-circle')
			TestObject select_acc =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/div_Select (1)')
			TestObject select_dda =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/span_DDA')
			TestObject save =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/button_Save')
			TestObject actbalance =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/input_Available Balance_currentBalance')
			TestObject nameaddress =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/textarea_Name and Street Address_address')
			TestObject save1 =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/save1')
			TestObject actidentficationsymbol =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Case Processor/i_Timeline_fas fa-universal-access')
			WebUI.rightClick(timelinesearch)
			WebUI.click(selectAcct_identification)
	...
	def legalActIdentificationview() {
		try {
			TestObject dda =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/td_DDA')
			TestObject close =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Account Identification Actions/button_Close')
			TestObject timelinesearch =findTestObject('Object Repository/Web/Dispute/Process/Case Processor/Page_Case Process/i_Timeline_fas fa-search')
	...
	def legalJurisdictionview() {
		try {
			...
			TestObject feeamt =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Case Processor/input_Fee Amount_Fee Amount')
			TestObject maxfee =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Case Processor/input_Maximum Fee_Maximum Fee')
			TestObject minfee =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Case Processor/input_Minimum Fee_Minimum Fee')
			TestObject orderfl =findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_Case Processor/input_Order Jurisdiction_jurisdiction')
	...
	@Keyword
	def addAccount_identification_FundsAcquistion1(String bankid,String acctno,String actbal) {
		try {
			TestObject select_acct=findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_AccountIdentification_Action/select_acct')
			TestObject selectAcct_identification1= findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_AccountIdentification_Action/span_Account Identification Action1')
			TestObject selectAcct_identification= findTestObject('Object Repository/Web/Legal/Process/CaseProcesser/Page_AccountIdentification_Action/span_Account Identification Action')
